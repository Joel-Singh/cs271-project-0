...
void test_insert() {
  try {
    ...
    if (dll.to_string() != "2 -1 1 5") {
      cout << "Incorrect insert result. Expected 2 -1 1 5 but got : " << dll_str
           << endl;
    }
  } catch (std::exception &e) {
...
void test_remove() {
  try {
    ...
    string dll_str = dll.to_string();
    if (dll_str != "2 3 4 5") {
      cout << "Incorrect remove result. Expected 2 3 4 5 but got : " << dll_str
           << endl;
    }
...
void test_copy_constructor() {
  try {
    ...
    dll_str = y.to_string();
    if (dll_str != "0 2 -1 9") {
      cout << "Incorrect copy constructor result after append. Expected 0 2 -1 "
              "9 but got : "
           << dll_str << endl;
    }
    ...
    dll_str = y.to_string();
    if (dll_str != "0 2 -1 9") {
      cout << "Incorrect copy constructor result after remove. Expected 0 2 -1 "
              "9 but got : "
           << dll_str << endl;
    }
    ...
    dll_str = x.to_string();
    if (dll_str != "2 -1 3") {
      cout << "Incorrect copy constructor result after remove. Expected 2 -1 3 "
              "but got : "
           << dll_str << endl;
    }
